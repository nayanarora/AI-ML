...
model_vgg16bn = PretrainedAlexNet().to(device)
model_inceptionv3 = PretrainedBinaryAlexNet().to(device)
...
for epoch in range(num_epochs):
    ...
    print("Epoch : {} AlexNet Train Loss : {:.6f} AlexNet Train Acc : {:.6f}".format(epoch+1,avg_train_loss,avg_train_acc))
    print("Epoch : {} AlexNet Valid Loss : {:.6f} AlexNet Valid Acc : {:.6f}".format(epoch+1,avg_valid_loss,avg_valid_acc))
...
for epoch in range(num_epochs):
    ...
    print("Epoch : {} B-AlexNet Train Loss : {:.6f} B-AlexNet Train Acc : {:.6f}".format(epoch+1,avg_train_loss,avg_train_acc))
    print("Epoch : {} B-AlexNet Valid Loss : {:.6f} B-AlexNet Valid Acc : {:.6f}".format(epoch+1,avg_valid_loss,avg_valid_acc))

plt.title('B-AlexNet Training Loss')
plt.xlabel('Steps')
plt.ylabel('Losses')
plt.plot(steps, training_loss)
plt.show()

plt.title('B-AlexNet Training accuracy')
plt.xlabel('Steps')
plt.ylabel('Accuracy')
plt.plot(steps, training_accuracy)
plt.show()

plt.title('B-AlexNet Validation Loss')
plt.xlabel('Steps')
plt.ylabel('Losses')
plt.plot(steps, validation_loss)
plt.show()

plt.title('B-AlexNet Validation accuracy')
plt.xlabel('Steps')
plt.ylabel('Accuracy')
plt.plot(steps, validation_accuracy)
plt.show()
